...
one month out (346–488 around a point forecast of 417), and widens
...
(1) the series showed growing seasonal amplitude in the STL decomposition a signature of multiplicative seasonality and this model was fit on the raw scale rather than a log transform, which may leave some of that structure unmodeled.
(2) stitching 8 rolling-origin windows into one residual series for this test can itself introduce artificial structure at the window seams, which Ljung-Box (built for one continuous series) may partly be picking up rather than a true model deficiency.
